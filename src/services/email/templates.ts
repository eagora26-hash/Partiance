...
const COPY = {
  verify: {
    it: {
      subject: 'Conferma il tuo indirizzo email · Partiance',
      heading: 'Benvenuto in Partiance',
      body: (name: string) =>
    ...
    en: {
      subject: 'Confirm your email · Partiance',
      heading: 'Welcome to Partiance',
      body: (name: string) =>
  ...
  reset: {
    it: {
      subject: 'Reimposta la tua password · Partiance',
    ...
    en: {
      subject: 'Reset your password · Partiance',
...
<html><body style="margin:0;background:#050816;font-family:Inter,Arial,sans-serif;color:#F9FAFB;padding:32px">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;margin:0 auto">
    <tr><td style="padding-bottom:24px;font-size:20px;font-weight:700">◆ Partiance</td></tr>
    ...
    <tr><td style="padding-top:24px;font-size:12px;color:#64748B">Partiance · Build Better Together</td></tr>
  </table>
</body></html>`;
}
